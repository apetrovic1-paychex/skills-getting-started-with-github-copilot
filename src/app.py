...
activities = {
    ...
    "Drama Club": {
        "description": "Rehearse and perform in school plays and theater productions",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "harper@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Prepare for and compete in math competitions and problem-solving challenges",
